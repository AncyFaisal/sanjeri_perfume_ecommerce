...
from sanjeri_app.views.admin_offer_views import (
    ...
    seasonal_discount_list, seasonal_discount_create, seasonal_discount_edit,
    seasonal_discount_delete, seasonal_discount_toggle_status,
    referral_offer_manage
)
...
path('offers/seasonal/', seasonal_discount_list, name='seasonal_discount_list'),
path('offers/seasonal/create/', seasonal_discount_create, name='seasonal_discount_create'),
path('offers/seasonal/<int:offer_id>/edit/', seasonal_discount_edit, name='seasonal_discount_edit'),
path('offers/seasonal/<int:offer_id>/delete/', seasonal_discount_delete, name='seasonal_discount_delete'),
path('offers/seasonal/<int:offer_id>/toggle-status/', seasonal_discount_toggle_status, name='seasonal_discount_toggle_status'),

path('offers/referral/', referral_offer_manage, name='referral_offer_manage'),
